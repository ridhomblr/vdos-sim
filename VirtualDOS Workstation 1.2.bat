...
set registeredto=Leak
goto settings

:settings
color 09
echo Loading Default Settings for Leaf OS...
...
set vtl=On
set hdtleaf=HDD
echo Loading Default Settings for SimpleOS...
set usr2=Simple2LocalUser
set anm2=Simple2Administrators
set 
goto ftkbos
...
:greet
cls
title VirtualDOS Workstation 1.2 - Registered to %registeredto%. (%userprofile%).
...
if %select% == vm2 goto simpstarting
...
:simpstarting
cls
echo Starting %simpname%...
ping localhost -n 420691337666 >nul
goto exit